...
class Acta_entrega_certificados(View):
    def cabecera(self,pdf):
        ...
        pdf.drawString(325, 790, b"ACTA DE ENTRAGA DE CERTIFICADOS")
        pdf.drawString(426, 774, u"CÓDIGO EVENTO ")
        pdf.drawString(466, 761, u"########") ; pdf.drawString(260,720,"Aula")
        pdf.drawString(35, 720, u"Programa:") ; pdf.drawString(260, 705, u"Duración: 15 horas")
        ...
        """pdf.drawString(35, 675, u"Instructor:") ;""" 
    ...
    def tabla(self,pdf,y):
        ...
        va2 = Paragraph('''<b>Cedula</b>''', styleBH)
        va3 = Paragraph('''<b>Nombre</b>''', styleBH)
        va4 = Paragraph('''<b>Hora de asistencias</b>''', styleBH)
