...
class Acta_nota_evento(View):
    ...
    def tabla(self,pdf,y):
        ...
        va4 = Paragraph('''<b>Nota</b>''', styleBH)
        va5 = Paragraph('''<b>Calificación en letras</b>''', styleBH)
        ...
        detalle_orden = Table([encabezados] + detalles, colWidths=[1 * cm,3.5*cm, 6 * cm, 2.5 * cm, 4 * cm,2.5*cm,0.5*cm])
